...
public class LogUtils {
    ...
    public final static String LOGGER_SCARABR_DS_META = "scadabr-ds-meta";
    ...
    public final static String LOGGER_SCADABR_DAO_JDBC = "scadabr-dao-jdbc";
}
