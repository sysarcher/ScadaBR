...
public class DataTypes {
    ...
    public static LocalizableMessage getDataTypeMessage(int id) {
        switch (id) {
            case BINARY:
                return new LocalizableMessageImpl("common.dataTypes.binary");
            case MULTISTATE:
                return new LocalizableMessageImpl("common.dataTypes.multistate");
            case NUMERIC:
                return new LocalizableMessageImpl("common.dataTypes.numeric");
            case ALPHANUMERIC:
                return new LocalizableMessageImpl("common.dataTypes.alphanumeric");
            case IMAGE:
                return new LocalizableMessageImpl("common.dataTypes.image");
        }
