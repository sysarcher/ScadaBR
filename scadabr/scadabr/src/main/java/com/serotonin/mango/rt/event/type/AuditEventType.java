...
public class AuditEventType extends EventType {
    ...
    public void setEventTypeAlarmLevel(int type, AlarmLevels alarmLevel) {
        ...
        systemSettingsDao.setIntValue(AUDIT_SETTINGS_PREFIX + type, alarmLevel.mangoId);
    }
    ...
    public static void addPeriodMessage(List<LocalizableMessage> list, String propertyNameKey, int periodType,
            int period) {
        list.add(new LocalizableMessage("event.audit.property", new LocalizableMessage(propertyNameKey), Common.getPeriodDescription(periodType, period)));
    }
