...
public class DataSourceEditDwr extends DataSourceListDwr {
        ...
        try {
            ...
            if (serial) {
                response.addMessage(new LocalizableMessage(
                        "dsEdit.modbus.locatorTestIp.startError", e.getMessage()));
            } else {
                response.addMessage(new LocalizableMessage(
    ...
    public String testHttpRetrieverValueParams(String url, int timeoutSeconds,
        ...
        try {
            String data = common.getData(url,
                    ...
                    response = validatePoint(id, xid, name, locator,
                            new DataPointDefaulter() {
                                ...
                                public void setDefaultValues(DataPointVO dp) {
                                    ...
                                    PointEventDetectorVO high = EBI25Constants.findDetector(
                                    ...
                                    PointEventDetectorVO low = EBI25Constants.findDetector(
                                            dp.getEventDetectors(),
                                            false);
                                    if (low != null) {
    ...
    // MBus stuff
    //
    public DwrResponseI18n saveMBusDataSource(String name, String xid, Connection connection,
            int updatePeriodType, int updatePeriods) {
    ...
    //
    @MethodFilter
    public DwrResponseI18n saveFhz4JDataSource(String name, String xid, String commPortId, String fhzHousecode, boolean fhzMaster) {
    ...
    public String testPachubeValueParams(String apiKey, int timeoutSeconds,
        ...
        try {
            Map<String, PachubeValue> data = PachubeDataSourceRT.getData(
                    common.createHttpClient(timeoutSeconds,
