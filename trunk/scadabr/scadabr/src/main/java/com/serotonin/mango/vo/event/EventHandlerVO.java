...
public class EventHandlerVO implements Serializable,
        ...
        if (handlerType == TYPE_SET_POINT) {
            ...
            if (dp == null) {
                ...
                if (activeAction == SET_ACTION_POINT_VALUE) {
                    ...
                    } else if (dataType != dpActive.getPointLocator().getMangoDataType()) {
                ...
                if (inactiveAction == SET_ACTION_POINT_VALUE) {
                    ...
                    } else if (dataType != dpInactive.getPointLocator().getMangoDataType()) {
    ...
    public void addProperties(List<LocalizableMessage> list) {
        ...
        if (handlerType == TYPE_SET_POINT) {
            ...
            if (activeAction == SET_ACTION_POINT_VALUE) {
                AuditEventType.addPropertyMessage(list,
                        "eventHandlers.action.point", dataPointDao.getExtendedPointName(activePointId));
            ...
            if (inactiveAction == SET_ACTION_POINT_VALUE) {
                AuditEventType.addPropertyMessage(list,
                        "eventHandlers.action.point", dataPointDao.getExtendedPointName(inactivePointId));
    ...
    public void addPropertyChanges(List<LocalizableMessage> list,
        ...
        if (handlerType == TYPE_SET_POINT) {
            AuditEventType.maybeAddPropertyChangeMessage(list,
                    "eventHandlers.target", dataPointDao.getExtendedPointName(from.targetPointId),
                    dataPointDao.getExtendedPointName(targetPointId));
            AuditEventType.maybeAddPropertyChangeMessage(list,
                    "eventHandlers.activeAction",
                    ...
                    getSetActionMessage(activeAction));
            AuditEventType.maybeAddPropertyChangeMessage(list,
                    "eventHandlers.action.point", dataPointDao.getExtendedPointName(from.activePointId),
            ...
            AuditEventType.maybeAddPropertyChangeMessage(list,
                    ...
                    getSetActionMessage(inactiveAction));
            AuditEventType.maybeAddPropertyChangeMessage(list,
                    "eventHandlers.action.point", dataPointDao.getExtendedPointName(from.inactivePointId),
    ...
    private LocalizableMessage createRecipientMessage(
        ...
        for (RecipientListEntryBean recip : recipients) {
            ...
            if (recip.getRecipientType() == EmailRecipient.TYPE_MAILING_LIST) {
                ...
                msg = new LocalizableMessage("event.audit.recip.user", userDao.getUser(recip.getReferenceId()).getUsername());
            } else {
        ...
        if (handlerType == TYPE_SET_POINT) {
            ...
            if (text != null) {
                ...
                if (!SET_ACTION_CODES.isValidId(activeAction)) {
                    throw new LocalizableJsonException(
                            ...
                            "activeAction", text, SET_ACTION_CODES.getCodeList());
                }
            }
            ...
            if (text != null) {
                ...
                if (!SET_ACTION_CODES.isValidId(inactiveAction)) {
                    throw new LocalizableJsonException(
                            "emport.error.eventHandler.invalid",
                            "inactiveAction", text, SET_ACTION_CODES.getCodeList());
                }
            }
